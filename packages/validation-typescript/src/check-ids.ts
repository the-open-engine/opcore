...
export const TYPE_SCRIPT_LINT_PLUGIN_CHECK_ID = "typescript.lint-plugin";
export const TYPE_SCRIPT_IMPORT_GRAPH_CHECK_ID = "typescript.import-graph";
export const TYPE_SCRIPT_IMPORT_LAYER_RULES_CHECK_ID = "typescript.import-layer-rules";
...
export type TypeScriptValidationCheckId =
  ...
  | typeof TYPE_SCRIPT_LINT_PLUGIN_CHECK_ID
  | typeof TYPE_SCRIPT_IMPORT_GRAPH_CHECK_ID
  | typeof TYPE_SCRIPT_IMPORT_LAYER_RULES_CHECK_ID
