...
- The Rust graph fact-model foundation makes Rust node/edge kinds canonical and confirms SQLite store schema v1 already persists Rust fact columns; it does not add Rust extraction, pipeline, or CLI behavior.
