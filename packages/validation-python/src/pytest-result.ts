import type { PythonProjectContext, PythonPytestValidationCapabilityRun, ValidationDiagnostic } from "@the-open-engine/opcore-contracts";
...
export function finalizeCapabilityRun(cleanup: CleanupState, result: ProjectRunResult): ProjectRunResult {
  const cleanupEvidence: NonNullable<PythonPytestValidationCapabilityRun["cleanup"]> = {
