import type { PythonProjectToolProvenance, PythonPytestValidationCapabilityRun } from "@the-open-engine/opcore-contracts";
...
function cleanupFailureResult(
  ...
  counts: PythonPytestValidationCapabilityRun["counts"],
  collection: PythonPytestValidationCapabilityRun["collection"],
  path: string
): ProjectRunResult {
